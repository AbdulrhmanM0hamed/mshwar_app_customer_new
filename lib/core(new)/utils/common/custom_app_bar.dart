...
import 'package:cabme/core(new)/utils/constant/font_manger.dart';
import 'package:cabme/core(new)/utils/constant/styles_manger.dart';
import 'package:cabme/core(new)/utils/theme/app_colors.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: AppBar(
        ...
        shadowColor: showShadow ? AppColors.primary.withValues(alpha:0.1) : null,
