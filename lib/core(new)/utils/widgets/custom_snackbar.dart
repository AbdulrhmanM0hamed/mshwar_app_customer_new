  ...
  static void _showEnhancedSnackbar({
    ...
    switch (type) {
      case SnackbarType.success:
        ...
        iconBackgroundColor = const Color.fromARGB(255, 13, 184, 70); // Green-600
                  ...
                  child: Row(
                    children: [
                      ...
                      TweenAnimationBuilder<double>(
                        duration: Duration(milliseconds: 800 + (animationValue * 200).round()),
                        tween: Tween<double>(begin: 0.0, end: 1.0),
                        curve: Curves.elasticOut,
                        builder: (context, iconAnimation, child) {
                          // Clamp icon animation values to prevent elasticOut overshoot
                          final clampedIconValue = iconAnimation.clamp(0.0, 1.0);
                          final iconScaleValue = (iconAnimation * 0.8 + 0.2).clamp(0.2, 1.0);
