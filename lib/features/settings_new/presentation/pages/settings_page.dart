...
import 'package:cabme/features/settings_new/presentation/pages/privacy_policy_page.dart';
import 'package:cabme/features/settings_new/presentation/pages/terms_of_service_page.dart';
import 'package:cabme/features/settings_new/presentation/pages/contact_us_page.dart';
...
class SettingsView extends StatelessWidget {
  ...
  static const double _tileVPadding = 2;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<ProfileCubit, ProfileState>(
              builder: (context, state) {
                if (state is ProfileLoaded) {
                  return _buildUserProfile(context, state.user, isDarkMode);
                }
            ...
            _buildSectionHeader(l10n.rideManagement, isDarkMode),
                ...
                children: [
                  _buildMenuItem(
                    ...
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const ActiveRidesPage()),
                    ),
                  ),
            ...
            _buildSectionHeader(l10n.accountPayments, isDarkMode),
            const SizedBox(height: 8),
            _buildCard(
              isDarkMode: isDarkMode,
              child: Column(
            ...
            _buildSectionHeader(l10n.appSettings, isDarkMode),
            const SizedBox(height: 8),
            _buildCard(
              isDarkMode: isDarkMode,
              child: Column(
            ...
            _buildSectionHeader(l10n.feedbackSupport, isDarkMode),
            const SizedBox(height: 8),
            _buildCard(
              isDarkMode: isDarkMode,
              child: Column(
      ...
      child: Row(
        children: [
          ClipRRect(
            ...
            child: _buildProfileImage(userModel, isDarkMode),
          ),
  ...
  Widget _buildDarkModeToggle(BuildContext context, bool isDarkMode,
      DarkThemeProvider themeChange, AppLocalizations l10n) {
    return ListTile(
      dense: true,
      visualDensity: VisualDensity.compact,
      contentPadding: const EdgeInsets.symmetric(
