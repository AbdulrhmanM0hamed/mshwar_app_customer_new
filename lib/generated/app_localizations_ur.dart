...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get allRides => 'تمام سواریاں';

  @override
  String get scheduledRides => 'شیڈول شدہ سواریاں';
  ...
  @override
  String get payNow => 'ابھی ادائیگی کریں';
  ...
  @override
  String get noCouponsAvailable => 'کوئی کوپن دستیاب نہیں';

  @override
  String get couponCodeCopied => 'کوپن کوڈ کاپی ہو گیا';

  @override
  String get validTill => 'تک درست';

  @override
  String get activeRides => 'فعال سفر';

  @override
  String get rideHistory => 'سفر کی تاریخ';

  @override
  String get rideDetails => 'سفر کی تفصیلات';

  @override
  String get searchingForDriver => 'ڈرائیور تلاش کر رہے ہیں';

  @override
  String get driverAssigned => 'ڈرائیور مقرر کیا گیا';

  @override
  String get driverArrived => 'ڈرائیور پہنچ گیا';

  @override
  String get onRide => 'سواری پر';

  @override
  String get rejected => 'مسترد';

  @override
  String get errorLoadingRides => 'سفر لوڈ کرنے میں خرابی';

  @override
  String get errorLoadingHistory => 'تاریخ لوڈ کرنے میں خرابی';

  @override
  String get noActiveRides => 'کوئی فعال سفر نہیں';

  @override
  String get noRideHistory => 'کوئی سفر کی تاریخ نہیں';

  @override
  String get bookARideToGetStarted => 'شروع کرنے کے لیے سفر بک کریں';

  @override
  String get yourCompletedRidesWillAppearHere =>
      'آپ کے مکمل شدہ سفر یہاں ظاہر ہوں گے';

  @override
  String get chatWithDriver => 'ڈرائیور سے چیٹ کریں';
  ...
  @override
  String get addReview => 'جائزہ شامل کریں';

  @override
  String get rateYourRide => 'اپنے سفر کی درجہ بندی کریں';

  @override
  String get writeAReview => 'جائزہ لکھیں (اختیاری)';

  @override
  String get submitReview => 'جائزہ جمع کرائیں';

  @override
  String get reviewSubmitted => 'جائزہ کامیابی سے جمع ہو گیا';

  @override
  String get addComplaint => 'شکایت شامل کریں';

  @override
  String get complaintType => 'شکایت کی قسم';

  @override
  String get selectComplaintType => 'شکایت کی قسم منتخب کریں';

  @override
  String get driverBehavior => 'ڈرائیور کا رویہ';

  @override
  String get vehicleCondition => 'گاڑی کی حالت';

  @override
  String get routeIssue => 'راستے کا مسئلہ';

  @override
  String get paymentIssue => 'ادائیگی کا مسئلہ';

  @override
  String get safetyIssue => 'حفاظت کا مسئلہ';

  @override
  String get describeYourComplaint => 'اپنی شکایت بیان کریں';

  @override
  String get submitComplaint => 'شکایت جمع کرائیں';

  @override
  String get complaintSubmitted => 'شکایت کامیابی سے جمع ہو گئی';

  @override
  String get callDriver => 'ڈرائیور کو کال کریں';
  ...
  String get areYouSureYouWantToCancelThisRide =>
      'کیا آپ واقعی اس سفر کو منسوخ کرنا چاہتے ہیں؟';

  @override
  String get cancellationReason => 'منسوخی کی وجہ (اختیاری)';

  @override
  String get rideCancelled => 'سفر کامیابی سے منسوخ ہو گیا';
  ...
  @override
  String get vehiclePlate => 'گاڑی کی پلیٹ';
  ...
  @override
  String get contactDriver => 'ڈرائیور سے رابطہ کریں';
  ...
  @override
  String get enRoute => 'راستے میں';

  @override
  String get arrived => 'پہنچ گیا';
  ...
  @override
  String get driverContact => 'ڈرائیور کا رابطہ';

  @override
  String get carDetails => 'گاڑی کی تفصیلات';

  @override
  String get licensePlate => 'لائسنس پلیٹ';
  ...
  String get searchByLocation =>
      'مقام، تاریخ، وقت، یا سواری ID سے تلاش کریں...';

  @override
  String get searchByHint => 'تلاش کریں: پک اپ، منزل، تاریخ، وقت، یا سواری ID';

  @override
  String get errorLoadingScheduledRides =>
      'شیڈول شدہ سواریاں لوڈ کرنے میں خرابی';

  @override
  String get noScheduledRidesFound => 'کوئی شیڈول شدہ سواری نہیں ملی';

  @override
  String get tryDifferentSearch => 'مختلف تلاش کی اصطلاح آزمائیں';

  @override
  String get noRecentSearches => 'کوئی حالیہ تلاشیں نہیں';
  ...
  @override
  String get locationSearching => 'مقام تلاش کر رہے ہیں...';

  @override
  String get notFoundLocation => 'مقام نہیں ملا';

  @override
  String get suggestedLocation => 'تجویز کردہ مقام';
  ...
  @override
  String get driverEstimateArrivalTime => 'ڈرائیور کی تخمینی آمد کا وقت';

  @override
  String get hideMyLocation => 'میری لوکیشن چھپائیں';

  @override
  String get showMyLocation => 'میری لوکیشن دکھائیں';
  ...
  String get locationPermissionsPermanentlyDenied =>
      'مقام کی اجازتیں مستقل طور پر مسترد کر دی گئی ہیں۔ براہ کرم انہیں ترتیبات میں فعال کریں۔';

  @override
  String get tripHash => 'سفر #';
  ...
  @override
  String get thankYouForFeedback => 'آپ کی رائے کا شکریہ!';

  @override
  String get reviewSubmittedSuccessfully =>
      'آپ کی درجہ بندی کامیابی کے ساتھ جمع کر دی گئی ہے۔ ہم آپ کے سواری کے تجربے کو بہتر بنانے میں مدد کرنے کے لیے آپ کی ان پٹ کی قدر کرتے ہیں۔';

  @override
  String get cancelTrip => 'سفر منسوخ کریں';

  @override
  String get writeCancelReason => 'سفر منسوخ کرنے کی وجہ لکھیں';

  @override
  String get pleaseEnterReason => 'براہ کرم کوئی وجہ درج کریں';

  @override
  String get doYouWantToCancel => 'کیا آپ اس بکنگ کو منسوخ کرنا چاہتے ہیں؟';

  @override
  String get iDoNotFeelSafe => 'میں محفوظ محسوس نہیں کر رہا ہوں';
